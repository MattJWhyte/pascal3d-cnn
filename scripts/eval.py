...
def predict_model(pth, net, net_name):
    ...
    ax2.scatter(train_pred_az, train_el_diff, cmap="hsv", c=[t/360.0 for t in train_target_az], s=5)
    ...
    ax2.scatter(test_pred_az, test_el_diff, cmap="hsv", c=[t/360.0 for t in test_target_az], s=5)
